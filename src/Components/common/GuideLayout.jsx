        ...
        <div className='relative min-h-screen bg-base-100 max-w-full overflow-x-hidden'>
            <div className="px-4 py-12 md:px-12 lg:px-24">
                ...
                <div className='text-center space-y-4 mb-20'>
                    <h1 className='heading text-4xl md:text-7xl'>{title}</h1>
            ...
            {selectedPrinciple && (
                <div className="fixed inset-0 z-[100] flex justify-end bg-black/40" onClick={() => setSelectedPrinciple(null)}>
                    <div
                        data-lenis-prevent
                        className="w-full max-w-lg h-full bg-base-100 p-10 md:p-12 shadow-2xl flex flex-col gap-12 overflow-y-auto border-l border-base-300 custom-scrollbar animate-in slide-in-from-right"
                        ...
                        <div className="mt-auto pt-10">
                            <div className="p-8 rounded-[2rem] bg-primary/5 border border-primary/10 relative overflow-hidden group">
                                ...
                                <p className="text-xs text-base-content/60 leading-relaxed italic relative z-10">
                                    {insightLabel}: <span className="text-primary font-black uppercase tracking-wider">{selectedPrinciple.Title}</span> is critical for long-term scalability and system integrity.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            {footerNoteText && (
                <div className="mt-32 p-12 rounded-[3rem] bg-base-200 text-center border border-base-300 mx-4 md:mx-12 lg:mx-24 mb-20 shadow-sm">
                    ...
                    <h3 className="text-2xl font-black mb-4 uppercase tracking-tight">{footerNoteTitle || "Concept Summary"}</h3>
