...
const Tool_Lib_Card = ({ Name, Summary, URL }) => {
  return (
    <>
      ...
      >
        <div className="card bg-base-200 shadow-sm border border-base-300 text-base-content hover:shadow-md">
          <div className="card-body">
            ...
            <a
              className="text-base-content/25 mt-0 break-words text-xs"
              href={URL}
              target="_blank"
